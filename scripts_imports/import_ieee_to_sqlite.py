...
json_path = PROJECT_ROOT / "bdSource" / "IEEE_llm_Journals_1825.json"
if not json_path.exists():
    raise FileNotFoundError(f"Le fichier JSON est introuvable : {json_path}")

with open(json_path, "r", encoding="utf-8") as f:
    data = json.load(f)

# Connexion SQLite
db_path = PROJECT_ROOT / "bd" / "ieee_llm_articles.db"
